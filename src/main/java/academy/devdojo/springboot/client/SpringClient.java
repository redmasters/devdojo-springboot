...
public class SpringClient {
    public static void main(String[] args) {
        ...
        Anime[] animes = new RestTemplate().getForObject("http://localhost:8082/animes/all", Anime[].class);
        log.info(Arrays.toString(animes));

        //formatter.off
        ResponseEntity<List<Anime>> exchange = new RestTemplate().exchange("http://localhost:8082/animes/all",
                HttpMethod.GET,
                null,
...
//                "http://localhost:8082/animes/", kingdom, Anime.class);
